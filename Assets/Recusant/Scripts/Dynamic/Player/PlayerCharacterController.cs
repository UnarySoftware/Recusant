...
namespace Recusant
{
    ...
    public class PlayerCharacterController : NetworkBehaviour, ICharacterController
    {
        ...
        [SerializeField]
        private SingleLayer _motorMoverLayer = GameObjectLayerMask.MotorMover;
        ...
        public SingleLayer ProxyPlayerLayer = GameObjectLayerMask.ProxyPlayer;
        public SingleLayer ProxyProxyPhysicsMover = GameObjectLayerMask.ProxyPhysicsMover;
        ...
        public bool IsColliderValidForCollisions(Collider coll)
        {
            ...
            if (layer == ProxyPlayerLayer ||
                layer == ProxyProxyPhysicsMover)
            {
                return false;
            }
