...
namespace Recusant.Editor
{
    ...
    public class PrefabManager
    {
        ...
        {
            Core.Editor.VersionAssetPostprocessor.OnPostprocessAssets += OnPostprocessAllAssets;
            Core.Editor.VersionModificationProcessor.OnSaveAssets += OnWillSaveAssets;
        }
