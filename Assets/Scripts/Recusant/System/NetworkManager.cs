...
namespace Recusant
{
    public class NetworkManager : System<NetworkManager>
    {
        ...
        private void InitConfig()
        {
            ...
            List<GameObject> prefabs = ContentLoader.Instance.LoadAssets<GameObject>(ContentEntryType.PrefabsNetwork);
        ...
        public void StartHost()
        {
            ...
            if (!File.Exists("Saves/Server/Default.sav"))
            {
        ...
        public void StartClient()
        {
            ...
            if (!File.Exists("Saves/Client/Default.sav"))
            {
        ...
        {
            NetworkClientConnectedEvent.Instance.Publish(sandbox, client);
        }

        public void OnPlayerConnected(NetworkSandbox sandbox, NetworkPlayer player)
        {
            NetworkPlayerConnectedEvent.Instance.Publish(sandbox, player);
        }
        ...
        public void OnPlayerDisconnected(NetworkSandbox sandbox, NetworkPlayer player, TransportDisconnectReason reason)
        {
            NetworkPlayerDisconnectedEvent.Instance.Publish(sandbox, player, reason);
        }
